...
<head>
    ...
    <title>Member Form | PHP - JSON CRUD</title>
                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-atuo">
                                    <button class="btn btn-primary btn-sm btn-flat" id="add"><i class="fa fa-plus-square"></i> Add Member</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <?php else: ?>
                                    <p class="text-muted"><i>Add New Member</b></i></p>
                                <?php endif; ?>
